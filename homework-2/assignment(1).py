...
# example_query_term_ids = [54, 846, 2208]
...
positional_language_model(example_document_id, example_query_id, kernel=gauss_kernel_table, kernel_integral=gauss_integral_table, mu=0.1)
